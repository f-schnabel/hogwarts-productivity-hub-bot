...
import * as JournalService from "@/discord/events/interactionCreate/admin/journalService.ts";
import { client } from "@/discord/client.ts";
import { Events, SlashCommandSubcommandBuilder, type Client } from "discord.js";
import * as VoiceStateUpdate from "@/discord/events/voiceStateUpdate/index.ts";
import * as ClientReady from "@/discord/events/clientReady/index.ts";
